...
class ColumnSchema extends Object
{
     ...
     * @var boolean whether this column is unsigned.
    ...
    {
        // the default implementation does the same as casting for PHP, but it should be possible to override this with annotation of explicit PDO type.
