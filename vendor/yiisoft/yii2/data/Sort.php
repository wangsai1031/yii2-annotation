 ...
 * This can be passed to [[\yii\db\Query::orderBy()]] to construct a DB query. This property is read-only.
 *
...
class Sort extends Object
{
     ...
     * In the above, two attributes are declared: "age" and "name".
     * The "age" attribute is a simple attribute which is equivalent to the following:
     *
     * ```php
     * 'age' => [
     *     'asc' => ['age' => SORT_ASC],
     ...
     * @var \yii\web\UrlManager the URL manager used for creating sort URLs.
     * If not set, the "urlManager" application component will be used.
     */
    public $urlManager;
     ...
     * @return boolean|null Sort direction of the attribute.
     * Can be either `SORT_ASC` for ascending order or `SORT_DESC` for descending order.
     * Null is returned if the attribute is invalid or does not need to be sorted.
     */
