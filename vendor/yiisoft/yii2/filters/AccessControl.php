...
class AccessControl extends ActionFilter
{
     ...
     * @var callable a callback that will be called if the access should be denied to the current user.
     ...
     * If a rule is specified via a configuration array,
     * it will be merged with [[ruleConfig]] first before it is used for creating the rule object.
     * @see ruleConfig
     */
    public $rules = [];
