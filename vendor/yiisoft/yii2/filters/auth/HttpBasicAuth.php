...
class HttpBasicAuth extends AuthMethod
{
     ...
     * The callable receives a username and a password as its parameters.
     ...
     * If this property is not set, the username information will be considered as an access token while the password information will be ignored.
     * The [[\yii\web\User::loginByAccessToken()]] method will be called to authenticate and login the user.
     */
    public $auth;
