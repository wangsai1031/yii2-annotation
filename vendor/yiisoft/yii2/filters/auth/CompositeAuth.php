...
class CompositeAuth extends AuthMethod
{
     ...
     * @var array the supported authentication methods.
     * This property should take a list of supported authentication methods, each represented by an authentication class or configuration.
     *
     * 如果该属性为空，则不执行身份验证
