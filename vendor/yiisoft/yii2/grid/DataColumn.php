 ...
 * A simple data column definition refers to an attribute in the data model of the  GridView's data provider.
 * The name of the attribute is specified by [[attribute]].
 *
 ...
 * A data column differentiates between the [[getDataCellValue|data cell value]] and the [[renderDataCellContent|data cell content]].
 * The cell value is an un-formatted value that may be used for calculation,
 * while the actual cell content is a [[format|formatted]] version of that value which may contain HTML markup.
 *
...
class DataColumn extends Column
{
     ...
     *
     * @var string|array in which format should the value of each data model be displayed as (e.g. `"raw"`, `"text"`, `"html"`,`['date', 'php:Y-m-d']`).
     * Supported formats are determined by the [[GridView::formatter|formatter]] used by the [[GridView]].
     * Default format is "text" which will format the value as an HTML-encoded plain text when [[\yii\i18n\Formatter]] is used as the [[GridView::$formatter|formatter]] of the GridView.
     */
    public $format = 'text';
    /**
