...
class ActionColumn extends Column
{
     ...
     * This property is mainly used by [[urlCreator]] to create URLs for different actions.
     * The value of this property will be prefixed to each action name to form the route of the action.
     */
    public $controller;
    /**
     ...
     * when the model is editable (here assuming you have a status field that indicates that):
     *
     * ```php
     * [
     ...
     * @var array visibility conditions for each button.
     * The array keys are the button names (without curly brackets), and the values are the boolean true/false or the anonymous function.
     * When the button name is not specified in this array it will be shown by default.
