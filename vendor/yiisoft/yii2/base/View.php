...
class View extends Component implements DynamicContentAwareInterface
{
    ...
    protected function findViewFile($view, $context = null)
    {
        ...
        // 若默认扩展名不是  .php 且 $path 不是文件，则直接使用扩展名 .php
    ...
    public function renderFile($viewFile, $params = [], $context = null)
    {
        ...
        if (is_file($viewFile)) {
            // 返回指定文件的本地化版本  "path/to/zh-CN/view.php" => "path/to/zh/view.php"
    ...
    public function renderPhpFile($_file_, $_params_ = [])
    {
         ...
         * extract() 把关联数组的键作为变量名，对应的值作为变量值
         */
     ...
     * 代码的返回值被看作是动态内容。这段代码将在每次请求时都执行，无论其外层的片段缓存是否被存储。
     ...
     * 参数 boolean 是否在当前位置输出该Block内容。默认是false，表示当前区块不会被展示。
     * 
