...
class Security extends Component
{
     ...
     * This must be the same as the value passed to [[hashData()]] when generating the hash for the data.
     ...
     * It indicates whether the hash value in the data is in binary format.
     * If false, it means the hash value consists of lowercase hex digits only.
     * hex digits will be generated.
    ...
    public function generateRandomKey($length = 32)
    {
        ...
        // Since 5.4.0, openssl_random_pseudo_bytes() reads from CryptGenRandom on Windows instead of using OpenSSL library.
        // LibreSSL is OK everywhere but don't use OpenSSL on non-Windows.
        ...
        // mcrypt_create_iv() does not use libmcrypt.
        // Since PHP 5.3.7 it directly reads CryptGenRandom on Windows.
        // Elsewhere it directly reads /dev/urandom.
