...
class BaseFileHelper
{
     ...
     *
     * 搜索是基于指定的语言代码的。
     * The searching is based on the specified language code.
     * In particular, a file with the same name will be looked for under the subdirectory whose name is the same as the language code.
     * For example, given the file "path/to/view.php"
     ...
     * @param string $src the source directory 源目录
     * @param string $dst the destination directory 目标目录
     * 目录复制选项
     ...
     * This method is similar to the PHP `mkdir()` function except that it uses `chmod()`
     * to set the permission of the created directory in order to avoid the impact of the `umask` setting.
     *
     * 要创建的目录的路径
     ...
     * The first match (i.e. the last on the list), if any, determines the fate.
     * Returns the element which matched, or null for undecided.
     *
