...
class ActiveForm extends Widget
{
     ...
     * This is because the default value of [[action]] is set to be the current request url
     * and each submit will add new parameters instead of replacing existing ones.
     ...
     * or if you want to take advantage of the `yii.activeForm` plugin.
     ...
     * @var array|string the URL for performing AJAX-based validation. This property will be processed by [[Url::to()]].
     * Please refer to [[Url::to()]] for more details on how to configure this property.
     ...
     * @var array the client validation options for individual attributes.
     * Each element of the array represents the validation options for a particular attribute.
     * @internal
     */
    public $attributes = [];
     ...
     * @param Model|Model[] $models the model(s) associated with this form. 关联该表单的model类
     *
     * 键-值对的标签选项
     ...
     *
     * 表单字段与模型和属性相关联
     * A form field is associated with a model and an attribute.
     * 它包含标签、输入表单和错误消息，并使用它们与终端用户进行交互，以便为该属性收集他们的输入数据
     * It contains a label, an input and an error message and use them to interact with end users to collect their inputs for the attribute.
     * @param Model $model the data model. 数据模型类
     * 属性名或表达式，对于属性表达式的格式，见 [[Html::getAttributeName()]]
     * @param string $attribute the attribute name or expression.
     * See [[Html::getAttributeName()]] for the format about attribute expression.
     * 字段对象的附加配置，这些是ActiveField或子类的属性，取决于fieldClass的值
     * @param array $options the additional configurations for the field object.
     * These are properties of [[ActiveField]] or a subclass, depending on the value of [[fieldClass]].
