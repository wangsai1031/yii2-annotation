 ...
 * Unlike the [[Cache]], ArrayCache allows the expire parameter of [[set]], [[add]], [[multiSet]] and [[multiAdd]] to be a floating point number,
 * so you may specify the time in milliseconds (e.g. 0.1 will be 100 milliseconds).
 *
