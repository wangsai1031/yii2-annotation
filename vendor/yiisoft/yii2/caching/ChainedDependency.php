 ...
 * When [[dependOnAll]] is true, if any of the dependencies has changed, this dependency is considered changed;
 * When [[dependOnAll]] is false, if one of the dependencies has NOT changed, this dependency is considered NOT changed.
 *
