 ...
 * MemCache supports both [memcache](http://pecl.php.net/package/memcache) and [memcached](http://pecl.php.net/package/memcached).
 * By setting [[useMemcached]] to be true or false, one can let MemCache to use either memcached or memcache, respectively.
 *
 ...
 * Please see [[MemCacheServer]] for available options.
 *
...
class MemCache extends Cache
{
     ...
     * To create an instance that persists between requests, you may specify a unique ID for the instance.
     * All instances created with the same ID will share the same connection.
     ...
     * Each element must be an array with the following keys: host, port, persistent, weight, timeout, retryInterval, status.
