 ...
 * The cache files are placed under [[cachePath]].
...
class FileCache extends Cache
{
     ...
     *
     * 为了确保互操作性，只能使用字母数字字符
     * @var string a string prefixed to every cache key.
     * This is needed when you store cache data under the same [[cachePath]] for different applications to avoid conflict.
     *
     ...
     * If the system has huge number of cache files (e.g. one million),
     * you may use a bigger value (usually no bigger than 3).
     * Using sub-directories is mainly to ensure the file system is not over burdened with a single directory having too many files.
     */
     ...
     * Defaults to 10, meaning 0.001% chance.
