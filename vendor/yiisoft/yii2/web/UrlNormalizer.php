...
class UrlNormalizer extends Object
{
     ...
     * @var boolean whether slashes should be collapsed, for example `site///index` will be converted into `site/index`
     */
    public $collapseSlashes = true;
    /**
     * 结尾斜杠是否应该按照规则的后缀设置进行规范化
     * @var boolean whether trailing slash should be normalized according to the suffix settings of the rule
     */
     ...
     * @param boolean $normalized if specified, this variable will be set to `true` if $pathInfo was changed during normalization
