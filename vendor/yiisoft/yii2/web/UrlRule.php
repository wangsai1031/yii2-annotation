...
class UrlRule extends Object implements UrlRuleInterface
{
     ...
     * When this rule is used to parse the incoming request,
     * the values declared in this property will be injected into $_GET.
     */
    public $defaults = [];
    /**
     ...
     * If `null`, [[UrlManager::normalizer]] will be used,
     * if `false`, normalization will be skipped for this rule.
     * @since 2.0.10
     */
    public $normalizer;
