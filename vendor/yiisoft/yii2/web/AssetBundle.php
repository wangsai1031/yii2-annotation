...
class AssetBundle extends Object
{
     ...
     * - an array, with the first entry being the URL or relative path as described before,
     *   and a list of key => value pairs that will be used to overwrite [[jsOptions]] settings for this entry.
