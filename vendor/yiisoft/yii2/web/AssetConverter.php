...
class AssetConverter extends Component implements AssetConverterInterface
{
     ...
     * The keys are the asset file extension names, and the values are the corresponding target script types (either "css" or "js") and the commands used for the conversion.
     *
     * 您还可以使用路径别名来指定命令的位置
