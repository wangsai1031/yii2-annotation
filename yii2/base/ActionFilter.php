...
class ActionFilter extends Behavior
{
    ...
    /**
     * 重写 attach 方法,绑定EVENT_BEFORE_ACTION 事件
     * {@inheritdoc}
     */
    ...
    protected function getActionId($action)
    {
        ...
        if ($this->owner instanceof Module) {
            ...
            // 获取在整个应用中该action的唯一id，包含模块ID(如果存在)、控制器ID,action ID
            $id = $action->getUniqueId();
            // 如果模块ID存在，并且以 action ID 模块ID开头，则去掉模块ID
